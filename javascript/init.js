...
document.addEventListener("DOMContentLoaded", () => {
  ...
  var pwaName = "Bars"; //Local Storage Names for PWA
  ...
  function init_template() {
    ...
    document
      .querySelectorAll('[data-menu-effect="menu-reveal"]')
      .forEach((el) => {
    ...
    function menuFunction() {
      if (menus.length) {
        ...
        var wrappers = document.querySelectorAll(".header, .page-content");
        var pageContent = document.querySelectorAll(".page-content");
        var menuHider = document.querySelectorAll(".menu-hider");
    ...
    function checkDarkMode() {
      ...
      function removeTransitions() {
        var falseTransitions = document.querySelectorAll(
          ".btn, .header, .menu-box, .menu-hider, .menu-active, .page-content"
        );
